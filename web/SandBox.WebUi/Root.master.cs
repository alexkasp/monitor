...
namespace SandBox.WebUi
{
    public partial class RootMaster : MasterPage
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            someScript2 = " <SCRIPT TYPE=\"text/javascript\">$(document).ready(function () { var r =  new Raphael(\"chartCountEv\"); r.hbarchart(0, 0, 137, 90, [[" + _osBadEventsRschTopValues[0] + ", " + _osBadEventsRschTopValues[1] + ", " + _osBadEventsRschTopValues[2] + ", " + _osBadEventsRschTopValues[3] + ", " + _osBadEventsRschTopValues[4] + "]],{\"gutter\":\"30%\",\"colors\":[\"#ffffff\"]}).label([]);var r2 = new Raphael(\"chartOSuse\"); r2.hbarchart(0, 0, 120, 90, [[" + _osRschTopValues[0] + ", " + _osRschTopValues[1] + ", " + _osRschTopValues[2] + ", " + _osRschTopValues[3] + ", " + _osRschTopValues[4] + "]],{\"gutter\":\"30%\",\"colors\":[\"#ffffff\"],\"rtl\":true}).label([]);});var r3 = new Raphael(\"chartDanger\"); r3.hbarchart(0, 0, 142, 90, [[" + _vpoTopValues[0] + ", " + _vpoTopValues[1] + "," + _vpoTopValues[2] + ", " + _vpoTopValues[3] + ", " + _vpoTopValues[4] + "]], { \"gutter\": \"30%\", \"colors\": [\"#ffffff\"] }).label([\"" + _vpoTopNames[0] + "\", \"" + _vpoTopNames[1] + "\", \"" + _vpoTopNames[2] + "\", \"" + _vpoTopNames[3] + "\", \"" + _vpoTopNames[4] + "\"]);</SCRIPT>";
