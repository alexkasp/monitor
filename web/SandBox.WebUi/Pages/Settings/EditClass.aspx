<%@ Page Title="" Language="C#" MasterPageFile="~/Main.master" AutoEventWireup="true"
    CodeBehind="EditClass.aspx.cs" Inherits="SandBox.WebUi.Account.EditClass" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <div id="content-top">
        <div id="pagename">
            Редактирование класса ВПО <a href="/Pages/Settings/Main.aspx">
...
<ItemStyle Wrap="True"></ItemStyle>
                            ...
                            <table style="width: 100%;padding-top:5px;">
                                <tr>
                                    ...
                                    <td style="width: 270px">
                                        <dx:ASPxComboBox ID="CBFileActiv" runat="server" ValueType="System.String" Width="270px" ClientInstanceName="CBFileActiv" ShowLoadingPanel="False" 
                                    IncrementalFilteringMode="StartsWith" EnableIncrementalFiltering="True">
                                        </dx:ASPxComboBox>
                                    </td>
                                    <td style="width: 500px">
                                        <dx:ASPxTextBox ID="TBNFileTaskValue" runat="server" Width="490px" ClientInstanceName="TBNFileTaskValue" NullText="[Параметр]">
                                        </dx:ASPxTextBox>
                                    </td>
                                    <td style="width: 20px">
	...
	LoadFSListData(s,hfReg);
                            ...
                            <table style="width: 100%;padding-top:5px;">
                                <tr>
                                    <td style="width: 35px">Задание</td>
                                    <td style="width: 270px">
                                        <dx:ASPxComboBox ID="CBRegActiv" runat="server" ValueType="System.String" Width="270px" ClientInstanceName="CBRegActiv" ShowLoadingPanel="False" 
                                    IncrementalFilteringMode="StartsWith" EnableIncrementalFiltering="True">
                                        </dx:ASPxComboBox>
                                    </td>
                                    <td style="width: 500px">
                                        <dx:ASPxTextBox ID="TBNRegTaskValue" runat="server" Width="490px" ClientInstanceName="TBNRegTaskValue" NullText="[Параметр]">
                                        </dx:ASPxTextBox>
                                    </td>
                                    <td style="width: 20px">
	...
	LoadFSListData(s,hfProc);
                            ...
                            <table style="width: 100%;padding-top:5px;">
                                <tr>
                                    <td style="width: 35px">Задание</td>
                                    <td style="width: 270px">
                                        <dx:ASPxComboBox ID="CBProcActiv" runat="server" ValueType="System.String" Width="270px" ClientInstanceName="CBProcActiv" ShowLoadingPanel="False" 
                                    IncrementalFilteringMode="StartsWith" EnableIncrementalFiltering="True">
                                        </dx:ASPxComboBox>
                                    </td>
                                    <td style="width: 500px">
                                        <dx:ASPxTextBox ID="TBProcTaskValue" runat="server" Width="490px" ClientInstanceName="TBProcTaskValue" NullText="[Параметр]">
                                        </dx:ASPxTextBox>
                                    </td>
                                    <td style="width: 20px">
	...
	LoadFSListData(s,hfNet);
                            ...
                            <table style="width: 100%;padding-top:5px;">
                                <tr>
                                    <td style="width: 35px">Задание</td>
                                    <td style="width: 270px">
                                        <dx:ASPxComboBox ID="CBNetActiv" runat="server" ValueType="System.String" Width="270px" ClientInstanceName="CBNetActiv" ShowLoadingPanel="False" 
                                    IncrementalFilteringMode="StartsWith" EnableIncrementalFiltering="True">
                                        </dx:ASPxComboBox>
                                    </td>
                                    <td style="width: 500px">
                                        <dx:ASPxTextBox ID="TBNetTaskValue" runat="server" Width="490px" ClientInstanceName="TBNetTaskValue" NullText="[Параметр]">
                                        </dx:ASPxTextBox>
                                    </td>
                                    <td style="width: 20px">
	...
	document.location.href = '/Pages/Settings/Main.aspx';
                            ...
                            <div style="float: right">
                                <dx:ASPxButton ID="btnCreate" runat="server" Text="Сохранить" ValidationGroup="AddResearchValidationGroup"
