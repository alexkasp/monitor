...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    <script type="text/javascript">
        ...
        function OnCopyButtonPress(values) {
            document.location.href = '/Pages/Research/NewResearch.aspx?copyfrom=' + values[0];
        }
            ...
            <asp:UpdatePanel ID="UpdateBtnPanel" runat="server" UpdateMode="Conditional">
                <ContentTemplate>
                    <table>
                        <tr>
                            <td width="150">
                                <dx:ASPxButton ID="btnNew" AutoPostBack="False" runat="server" Text="Создать" OnClick="btnNew_Click"
                                    CssClass="button" EnableDefaultAppearance="False" EnableTheming="False" Width="130px">
                                    ...
                                    <DisabledStyle CssClass="buttonDisable">
                                            ...
                                            <td width="150">
                                                <dx:ASPxButton ID="btnCopy" AutoPostBack="False" runat="server" Text="Копировать" ClientInstanceName="btnCopy"
                                                    ClientEnabled="False" CssClass="button" EnableDefaultAppearance="False" EnableTheming="False" Width="130px">
                                                    <ClientSideEvents Click="function(s, e) {
 	gridViewResearches.GetSelectedFieldValues('Id', OnCopyButtonPress);
}" />
                                                    <PressedStyle CssClass="buttonHover">
                                                    </PressedStyle>
                                                    <HoverStyle CssClass="buttonHover">
                            ...
                            <td width="150">
                                <dx:ASPxButton ID="btnComp" AutoPostBack="False" runat="server" Text="Сравнить" ClientInstanceName="btnComp"
                                    ClientEnabled="False" CssClass="button" EnableDefaultAppearance="False" EnableTheming="False"
                                    Width="130px">
                                    <ClientSideEvents Click="function(s, e) {
	gridViewResearches.GetSelectedFieldValues('Id', OnCompareButtonPress);
}" />
                                    <Image Url="~/Content/Images/Icons/btn_comp.png" UrlDisabled="~/Content/Images/Icons/btn_compd.png">
                                    </Image>
                                    <PressedStyle CssClass="buttonHover">
                                    </PressedStyle>
                                    <HoverStyle CssClass="buttonHover">
                            ...
                            <td width="150">
                                <dx:ASPxButton ID="btnStop" AutoPostBack="False" runat="server" Text="Остановить"
                                    ClientInstanceName="btnStop" ClientEnabled="False" CssClass="button" EnableDefaultAppearance="False"
                                    EnableTheming="False" Width="130px">
                                    <ClientSideEvents Click="function(s, e) {
	gridViewResearches.GetSelectedFieldValues('Id', OnStopButtonPress);
    gridViewResearches.UnselectAllRowsOnPage();
}" />
                                    <Image Url="~/Content/Images/Icons/btn_stop.png" UrlDisabled="~/Content/Images/Icons/btn_stopd.png">
                                    </Image>
                                    <PressedStyle CssClass="buttonHover">
                                    </PressedStyle>
                                    <HoverStyle CssClass="buttonHover">
                            ...
                            <td width="150">
                                <dx:ASPxButton ID="btnDel" AutoPostBack="False" runat="server" Text="Удалить" ClientInstanceName="btnDel"
                                    ClientEnabled="False" CssClass="button" EnableDefaultAppearance="False" EnableTheming="False"
                                    Width="130px">
                                    <ClientSideEvents Click="function(s, e) {
    ...
    gridViewResearches.UnselectAllRowsOnPage();
                                    ...
                                    <Image Url="~/Content/Images/Icons/btn_del.png" UrlDisabled="~/Content/Images/Icons/btn_deld.png">
                                    </Image>
                                    <PressedStyle CssClass="buttonHover">
                                    </PressedStyle>
                                    <HoverStyle CssClass="buttonHover">
        ...
        <div id="tablenavbuttons">
            <asp:UpdatePanel ID="UpdatePagerPanel" runat="server" UpdateMode="Conditional">
                <ContentTemplate>
                    <dx:ASPxPager ID="gridViewResearchesPager" runat="server" ItemCount="1000" ItemsPerPage="100"
                        OnPageIndexChanged="gridViewResearchesPager_PageIndexChanged" Visible="False"
                        OnPageSizeChanged="gridViewResearchesPager_PageSizeChanged" ShowNumericButtons="False"
                        Theme="SandboxTheme">
        ...
        <asp:UpdatePanel ID="UpdatePanelResearches" runat="server" UpdateMode="Conditional">
            <ContentTemplate>
                ...
                <dx:ASPxGridView ID="gridViewResearches" runat="server" KeyFieldName="Id" AutoGenerateColumns="False"
                    EnableTheming="True" Width="100%" OnHtmlRowPrepared="GridViewResearchesHtmlRowPrepared"
                    ClientInstanceName="gridViewResearches" Theme="SandboxTheme" OnCustomCallback="gridViewResearches_CustomCallback"
                    EnableCallBacks="False" OnCustomJSProperties="gridViewResearches_CustomJSProperties">
                    <ClientSideEvents RowClick="function(s, e) {
	                            ...
	                            if (s.GetSelectedRowCount()==1) btnCopy.SetEnabled(true);
	                            else if (s.GetSelectedRowCount()==2) btnComp.SetEnabled(true);
                            }" />
                    <Columns>
                        <dx:GridViewCommandColumn ShowSelectCheckbox="True" VisibleIndex="0" Width="20px"
                            Caption=" ">
                        </dx:GridViewCommandColumn>
                        <dx:GridViewDataTextColumn Caption="№" FieldName="Id" VisibleIndex="1" Name="Id"
                            UnboundType="Integer" Width="50px" SortIndex="0" SortOrder="Descending">
                            <PropertiesTextEdit>
                        ...
                        <dx:GridViewDataTextColumn Caption="Название" FieldName="ResearchName" VisibleIndex="2">
                            <PropertiesTextEdit>
                                <ValidationSettings ErrorText="Неверное значение">
                                    <RegularExpression ErrorText="Ошибка проверки регулярного выражения" />
                                </ValidationSettings>
                        ...
                        <dx:GridViewDataTextColumn Caption="Дата создания" FieldName="CreatedDate" VisibleIndex="3"
                            UnboundType="DateTime" Width="130px">
                            <PropertiesTextEdit>
                                <ValidationSettings ErrorText="Неверное значение">
                                    <RegularExpression ErrorText="Ошибка проверки регулярного выражения" />
                                </ValidationSettings>
                        ...
                        <dx:GridViewDataTextColumn Caption="Статус" FieldName="State" VisibleIndex="4" Width="80px">
                            <PropertiesTextEdit>
                                <ValidationSettings ErrorText="Неверное значение">
                                    <RegularExpression ErrorText="Ошибка проверки регулярного выражения" />
                                </ValidationSettings>
                        ...
                        <dx:GridViewDataTextColumn Caption="Тип" FieldName="VmType" VisibleIndex="7" Width="160px">
                            <PropertiesTextEdit>
                                <ValidationSettings ErrorText="Неверное значение">
                                    <RegularExpression ErrorText="Ошибка проверки регулярного выражения" />
                                </ValidationSettings>
                        ...
                        <dx:GridViewDataTextColumn Caption="ОС" FieldName="VmSystem" VisibleIndex="8" Width="170px">
                            <PropertiesTextEdit>
                                <ValidationSettings ErrorText="Неверное значение">
                                    <RegularExpression ErrorText="Ошибка проверки регулярного выражения" />
                                </ValidationSettings>
                        ...
                        <dx:GridViewDataTextColumn Caption="Длительность" FieldName="TimeElapsed" VisibleIndex="5"
                            Width="120px">
                            <PropertiesTextEdit>
                                <ValidationSettings ErrorText="Неверное значение">
                                    <RegularExpression ErrorText="Ошибка проверки регулярного выражения" />
                        ...
                        <dx:GridViewDataTextColumn Caption="Файл. система" FieldName="fsEventsCount" VisibleIndex="9"
                            Width="120px">
                            <Settings AllowHeaderFilter="False" />
                            <CellStyle HorizontalAlign="Left">
                            </CellStyle>
                        </dx:GridViewDataTextColumn>
                        <dx:GridViewDataTextColumn Caption="Реестр" VisibleIndex="10" FieldName="regEventsCount"
                            Width="70px">
                            <Settings AllowHeaderFilter="False" />
                            <CellStyle HorizontalAlign="Left">
                            </CellStyle>
                        </dx:GridViewDataTextColumn>
                        <dx:GridViewDataTextColumn Caption="Сеть" FieldName="netEventsCount" VisibleIndex="11"
                            Width="50px">
                            <Settings AllowHeaderFilter="False" />
                            <CellStyle HorizontalAlign="Left">
                            </CellStyle>
                        </dx:GridViewDataTextColumn>
                        <dx:GridViewDataTextColumn Caption="Процессы" FieldName="procEventsCount" VisibleIndex="12"
                            Width="80px">
                            <Settings AllowHeaderFilter="False" />
                            <CellStyle HorizontalAlign="Left">
                            </CellStyle>
                        </dx:GridViewDataTextColumn>
                        <dx:GridViewDataTextColumn Caption="Времени осталось" FieldName="TimeLeft" Visible="False"
                            VisibleIndex="13">
                            <PropertiesTextEdit>
                                <ValidationSettings ErrorText="Неверное значение">
                                    <RegularExpression ErrorText="Ошибка проверки регулярного выражения" />
                        ...
                        <dx:GridViewDataTextColumn Caption="Монитор" Visible="False" VisibleIndex="15">
                            <PropertiesTextEdit>
                                <ValidationSettings ErrorText="Неверное значение">
                                    <RegularExpression ErrorText="Ошибка проверки регулярного выражения" />
                                </ValidationSettings>
                            ...
                            <DataItemTemplate>
                                <dx:ASPxHyperLink ID="HLCurrentReport" runat="server" Text="Текущее состояние исследования" />
                            </DataItemTemplate>
                            <CellStyle HorizontalAlign="Left">
                            </CellStyle>
                        </dx:GridViewDataTextColumn>
                    ...
                    <SettingsBehavior ColumnResizeMode="NextColumn" ConfirmDelete="True" EnableCustomizationWindow="True"
                        EnableRowHotTrack="True" HeaderFilterMaxRowCount="10" />
                            ...
                            <div class="detailrow">
                                <div id="detailrowheader">
                                    <div class="detailrowparams">
                                        ДОПЛНИТЕЛЬНЫЕ ПАРАМЕТРЫ ИССЛЕДОВАНИЯ</div>
                                    <div class="detailrowevents">
                                        РАСПРЕДЕЛЕНИЕ СОБЫТИЙ</div>
                                    ...
                                    <img src="../../Content/images/btn_report.png" alt="Подробный отчет" border="0" title="Подробный отчет" runat=server id="reportImg" />
                                        ...
                                        <asp:HyperLink ID="HyperLink1" runat="server" ImageUrl="~/Content/Images/btn_report.png"
                                            NavigateUrl="~/Pages/Research/ReportList.aspx">HyperLink</asp:HyperLink>
                                    </div>
                                </div>
                                <div id="detailrowcontent">
                                    <div class="detailrowparams">
                                        <dx:ASPxGridView ID="detailGrid" runat="server" OnBeforePerformDataSelect="Detail_DataSelect"
                                    ...
                                    <div class="detailrowevents">
                                        <img alt="Важные" src="../../Content/images/bluebox.png" />&nbsp;&nbsp;ВАЖНЫЕ&nbsp;&nbsp;&nbsp;&nbsp;<img
                                            alt="Очень важные" src="../../Content/images/redbox.png" />&nbsp;&nbsp;КРИТИЧЕСКИЕ
                ...
                <asp:Timer ID="Update_timer" runat="server" OnTick="UpdateTimerTick">
                </asp:Timer>
                &nbsp;
            </ContentTemplate>
            <Triggers>
