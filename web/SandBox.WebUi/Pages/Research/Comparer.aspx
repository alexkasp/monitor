<%@ Page Title="" Language="C#" MasterPageFile="~/Main.master" AutoEventWireup="true"
    CodeBehind="Comparer.aspx.cs" Inherits="SandBox.WebUi.Pages.Research.Comparer" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <div id="content-top">
        <div id="pagename">
            Сравнение исследований <a href="javascript: history.go(-1)">
    ...
    <div id="content-main">
        ...
        <div style="float: left; width: 47%;">
            ...
            <table style="width: 100%;">
                ...
                <tr>
                    <td style="width: 200px">
                        <dx:ASPxLabel ID="ASPxLabel10" runat="server" Text="Время создания:">
                        </dx:ASPxLabel>
                    </td>
                    <td>
                ...
                <tr>
                    <td style="width: 200px">
                        <dx:ASPxLabel ID="ASPxLabel11" runat="server" Text="Время запуска:">
                        </dx:ASPxLabel>
                    </td>
                    <td>
                ...
                <tr>
                    <td style="width: 200px">
                        <dx:ASPxLabel ID="ASPxLabel13" runat="server" Text="Время завершения:">
                        </dx:ASPxLabel>
                    </td>
                    <td>
                ...
                <tr>
                    <td style="width: 200px">
                        <dx:ASPxLabel ID="ASPxLabel14" runat="server" Text="Таймер:">
                        </dx:ASPxLabel>
                    </td>
                    <td>
                            ...
                            <asp:UpdatePanel ID="ChartUpdatePanel" runat="server" UpdateMode="Conditional">
                                <ContentTemplate>
                                    <dx:WebChartControl ID="wcEventsSign1" runat="server" Height="200px" LoadingPanelText="Загрузка данных&amp;hellip;"
                                        ...
                                        ClientInstanceName="wcEventsSign1" EnableCallBacks="False" AlternateText="Диаграмма событий"
...
<dx:PanelContent ID="PanelContent" runat="server" SupportsDisabledAttribute="True"></dx:PanelContent>
        ...
        <div style="float: left; width: 47%;">
            ...
            <table style="width: 100%;">
                ...
                <tr>
                    <td style="width: 200px">
                        <dx:ASPxLabel ID="ASPxLabel2" runat="server" Text="Время создания:">
                        </dx:ASPxLabel>
                    </td>
                    <td>
                        <dx:ASPxLabel ID="LCreateTime2" runat="server">
                        </dx:ASPxLabel>
                    </td>
                </tr>
                <tr>
                    <td style="width: 200px">
                        <dx:ASPxLabel ID="ASPxLabel3" runat="server" Text="Время запуска:">
                        </dx:ASPxLabel>
                    </td>
                    <td>
                ...
                <tr>
                    <td style="width: 200px">
                        <dx:ASPxLabel ID="ASPxLabel15" runat="server" Text="Время завершения:">
                        </dx:ASPxLabel>
                    </td>
                    <td>
                ...
                <tr>
                    <td style="width: 200px">
                        <dx:ASPxLabel ID="ASPxLabel16" runat="server" Text="Таймер:">
                        </dx:ASPxLabel>
                    </td>
                    <td>
                        <dx:ASPxLabel ID="LTimerStopTime2" runat="server" Text="Не задан">
                        </dx:ASPxLabel>
                    </td>
                </tr>
                <tr>
                            ...
                            <asp:UpdatePanel ID="ChartUpdatePanel2" runat="server" UpdateMode="Conditional">
                                <ContentTemplate>
                                    <dx:WebChartControl ID="wcEventsSign2" runat="server" Height="200px" LoadingPanelText="Загрузка данных&amp;hellip;"
                                        SideBySideEqualBarWidth="True" Width="600px" CrosshairEnabled="False" ToolTipEnabled="False"
                                        ClientInstanceName="wcEventsSign2" EnableCallBacks="False" AlternateText="Диаграмма событий"
...
<dx:ToolTipMousePosition></dx:ToolTipMousePosition>
    ...
    wcEventsSign1.PerformCallback();
        ...
        <div style="clear: both">
            <fieldset>
                <legend>Сравнение образов реестра</legend>
                <dx:ASPxLabel ID="lbNoComp" runat="server" Text="Сравнения реестров не выполнено, т.к. операционные системы исследований различаются.">
                </dx:ASPxLabel>
                    ...
                    <ContentTemplate>
                        <dx:ASPxTreeList ID="RegTreeList" runat="server" AutoGenerateColumns="False" EnableCallbacks="False"
                            ...
                            <Columns>
                                ...
                                <dx:TreeListDataColumn FieldName="Etl" Name="Etl" VisibleIndex="1" Caption="Эталон"
                                    Width="20%">
                                </dx:TreeListDataColumn>
                                <dx:TreeListDataColumn FieldName="Reg" Name="Reg" VisibleIndex="2" Caption="Исследование 1"
                                    Width="20%">
                                </dx:TreeListDataColumn>
                                <dx:TreeListDataColumn FieldName="Reg2" Name="Reg2" VisibleIndex="3" Caption="Исследование 2"
                                    Width="20%">
                                </dx:TreeListDataColumn>
                            </Columns>
                            <Settings GridLines="Both" />
