CFLAGS=-g -std=c++0x
main: DaemonStarter.o Daemon.o Task.o myfunc.o Logger.o SimpleMonitor.o DaemonMonitor.o ScriptTask.o
	c++ $(CFLAGS) -o main main.cpp myfunc.o DaemonMonitor.o Daemon.o DaemonStarter.o Task.o Logger.o  SimpleMonitor.o ScriptTask.o
...
ScriptTask.o: ScriptTask.cpp ScriptTask.h
	c++ $(CFLAGS)  -c ScriptTask.cpp -o ScriptTask.o
clean:
	rm DaemonStarter.o Daemon.o Task.o Logger.o myfunc.o SimpleMonitor.o DaemonMonitor.o ScriptTask.o main